...
<html lang="nl">
    ...
    <head>
        <title>Reservering annuleren mislukt</title>
    ...
    <body>
        ...
        <p>Er is helaas een probleem opgetreden, waardoor uw reservering niet is geannuleerd</p>
        <br><br>
        <a href="reservation.php">Probeer het nog een keer</a>
        <br><br>
        <a href="home.php">Terug naar de homepagina</a>
